...
public interface MessagePrx {
	 ...
	 String encode(@TarsMethodParameter(name="sign")String sign);

	 String encode(@TarsMethodParameter(name="sign")String sign, @TarsContext java.util.Map<String, String> ctx);
	 ...
	 CompletableFuture<String>  promise_encode(@TarsMethodParameter(name="sign")String sign);

	 CompletableFuture<String>  promise_encode(@TarsMethodParameter(name="sign")String sign, @TarsContext java.util.Map<String, String> ctx);
